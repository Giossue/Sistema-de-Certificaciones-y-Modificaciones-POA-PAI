...
app.patch("/:id", requirePermission("modificacion.crear"), async (c) => modificacionesPoaController.editar(c));
app.post("/:id/observar", requirePermission("modificacion.observar"), async (c) => modificacionesPoaController.observar(c));
app.post("/:id/reenviar", requirePermission("modificacion.crear"), async (c) => modificacionesPoaController.reenviar(c));
