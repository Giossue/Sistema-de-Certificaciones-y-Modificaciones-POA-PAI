...
Tu trabajo es transformar los documentos de `.codex/` en una aplicación real, manteniendo arquitectura modular, reglas de negocio explícitas, trazabilidad completa y control monetario exacto.
...
1. `.codex/product/vision.md`
2. `.codex/product/scope.md`
3. `.codex/requirements/business-rules.md`
4. `.codex/architecture/overview.md`
5. `.codex/architecture/target-project-structure.md`
6. `.codex/architecture/modules.md`
7. `.codex/architecture/data-model.md`
8. `.codex/workflows/certificacion-poa-pai.md`
9. `.codex/workflows/modificacion-poa.md`
10. `.codex/workflows/importacion-cedula-mef.md`
11. `.codex/conventions/code.md`
12. `.codex/conventions/database.md`
13. `.codex/decisions/README.md`
...
Cuando el usuario pida iniciar desarrollo, primero genera la estructura indicada en `.codex/architecture/target-project-structure.md` y luego implementa por fases según `.codex/product/roadmap.md`.
